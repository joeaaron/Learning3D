...
void MyTitleBar::initControl()
{
	...
	m_pButtonRun = new QPushButton;
	m_pButtonClose = new QPushButton;

	m_pButtonMin->setFixedSize(QSize(BUTTON_WIDTH, BUTTON_HEIGHT));
	m_pButtonRestore->setFixedSize(QSize(BUTTON_WIDTH, BUTTON_HEIGHT));
	m_pButtonMax->setFixedSize(QSize(BUTTON_WIDTH, BUTTON_HEIGHT));
	m_pButtonRun->setFixedSize(QSize(BUTTON_WIDTH, BUTTON_HEIGHT));
	...
	m_pButtonRun->setObjectName("ButtonRun");
	m_pButtonClose->setObjectName("ButtonClose");

	m_pButtonRun->setIcon(QIcon(":/resource/images/run.png"));
	m_pButtonClose->setIcon(QIcon(":/resource/images/close.png"));
	...
	mylayout->addWidget(m_pButtonRun);
...
void MyTitleBar::initConnections()
{
	...
	connect(m_pButtonRun, SIGNAL(clicked()), this, SLOT(onButtonRunClicked()));
}
...
void MyTitleBar::onButtonRunClicked()
{
	emit signalButtonRunClicked();
}
